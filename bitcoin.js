...
function bitcoinprice() {
		...
		*/
		...
		while (plot < xAxisLength) {
			...
			if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 1)) {
				write(darkblue);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 2)) {
				write(blue);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 3)) {
				write(darkcyan);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 4)) {
				write(cyan);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 5)) {
				write(darkgreen);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 6)) {
				write(green);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 7)) {
				write(yellow);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 8)) {
				write(darkyellow);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 9)) {
				write(red);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 10)) {
				write(darkred);
			} else if (((flip - normBtcMin) / yAxisHeight) <= ((1/12) * 11)) {
				write(magenta);
			} else {
				write(darkmagenta);
			}
